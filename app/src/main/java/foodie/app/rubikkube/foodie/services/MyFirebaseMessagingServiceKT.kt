...
class MyFirebaseMessagingServiceKT : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        remoteMessage.data.isNotEmpty().let {
            ...
            sendNotification(message,toId,fromId,toName,fromName)
...
////            messageObject.put("toName",toName)
////            messageObject.put("fromName",fromName)
////            ObservableObject.getInstance().updateValue(messageObject)
////            mSocket?.emit("delivered",messageObject)
//
//
...
//            }
     ...
     */
    private fun sendNotification(messageBody: String,toId: String, fromId: String,toName : String,fromName : String) {
        val intent = Intent(this, ChatActivity::class.java)
        intent.putExtra("toUserId",toId)
        intent.putExtra("avatarUser",fromId)
        intent.putExtra("recieverName",toName)
        intent.putExtra("senderName",fromName)
        intent.putExtra("comingFromFCM",true)
