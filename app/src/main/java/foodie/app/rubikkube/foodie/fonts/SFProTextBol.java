...
public class SFProTextBol extends TextView {
	public SFProTextBol(Context context) {
		super(context);
		setFont();
	}
	public SFProTextBol(Context context, AttributeSet attrs) {
		super(context, attrs);
		setFont();
	}
	public SFProTextBol(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		setFont();
	}

	private void setFont() {
		Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/SFProText-Bold.ttf");
