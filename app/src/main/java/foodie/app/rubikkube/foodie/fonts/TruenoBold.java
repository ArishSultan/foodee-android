...
public class TruenoBold extends TextView {
	public TruenoBold(Context context) {
		super(context);
		setFont();
	}
	public TruenoBold(Context context, AttributeSet attrs) {
		super(context, attrs);
		setFont();
	}
	public TruenoBold(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		setFont();
	}

	private void setFont() {
		Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/TruenoExBd.otf");
