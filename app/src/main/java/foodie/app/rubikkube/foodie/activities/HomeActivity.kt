...
//            mSocket?.on("user-global-${Prefs.getString(Constants.USER_ID,"")}:new_notification",onNotificationReceived)
//
//        }
//    }
//
...
////            mSocket?.off("user-global-${Prefs.getString(Constants.USER_ID,"")}:new_notification",onNotificationReceived)
////
////        }
////    }
////
