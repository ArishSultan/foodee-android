...
public class SegoeSimiLight extends TextView {
	public SegoeSimiLight(Context context) {
		super(context);
		setFont();
	}
	public SegoeSimiLight(Context context, AttributeSet attrs) {
		super(context, attrs);
		setFont();
	}
	public SegoeSimiLight(Context context, AttributeSet attrs, int defStyle) {
