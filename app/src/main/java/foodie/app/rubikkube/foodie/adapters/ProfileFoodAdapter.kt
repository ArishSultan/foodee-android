...
import foodie.app.rubikkube.foodie.models.Food
...
import foodie.app.rubikkube.foodie.models.AddFoodResp
import foodie.app.rubikkube.foodie.models.DeleteFoodAndPostResponse
...
class ProfileFoodAdapter(context: Context, list : ArrayList<Food>,comingFrom:String)  : androidx.recyclerview.widget.RecyclerView.Adapter<ProfileFoodAdapter.ProfileFoodHolder>() {
    ...
    override fun onBindViewHolder(holder: ProfileFoodHolder, position: Int) {
        ...
        if(foodList[position].pivot.profileId != Prefs.getString(Constants.USER_ID,"")){
