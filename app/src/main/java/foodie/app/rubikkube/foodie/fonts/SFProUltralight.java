...
public class SFProUltralight extends TextView {
	public SFProUltralight(Context context) {
		super(context);
		setFont();
	}
	public SFProUltralight(Context context, AttributeSet attrs) {
		super(context, attrs);
		setFont();
	}
	public SFProUltralight(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		setFont();
	}

	private void setFont() {
		Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/SFProUltralight.ttf");
